...
public:
	...
	MVert* const toVertex() { return next()->fromVertex(); }//返回当前半边的下一个半边的顶点
...
public:
	MHalfedge* const halfEdge() { return he_; }
	const MHalfedge* const halfEdge() const { return const_cast<MEdge*>(this)->halfEdge(); /*return this->halfEdge();*/ }
	...
	void setSelected(bool select) { flag_show_ ? flag_select_ = select : flag_select_ = false; }//如果没有show，则flag_select_设置为false
